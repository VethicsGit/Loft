...
public class Topic {
    ...
    @Expose
    private String courseTopicDocumentation;
    ...
    public String getCourseTopicDocumentation() {
        return courseTopicDocumentation;
    }

    public void setCourseTopicDocumentation(String courseTopicDocumentation) {
