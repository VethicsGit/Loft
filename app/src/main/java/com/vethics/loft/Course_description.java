...
import adapter.SyllabusAdapter;
...
import model.CourseDetailsbyCourseId.Author;
import model.CourseDetailsbyCourseId.CourseDetailsData;
import model.CourseDetailsbyCourseId.CourseDetailsSuccessResponse;
import model.CourseDetailsbyCourseId.Language;
import model.CourseDetailsbyCourseId.Level;
...
public class Course_description extends AppCompatActivity implements View.OnClickListener, OnRecyclerViewItemClickListner, RatingDialogListener {


    TextView  course_desc_title,course_desc_stars,course_desc_enrolled,course_desc,course_desc_doller,course_desc_chepter ;
